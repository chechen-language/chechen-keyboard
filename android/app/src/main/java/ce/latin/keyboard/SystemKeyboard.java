...
public class SystemKeyboard extends InputMethodService implements OnKeyboardEventListener {
  ...
  public void onCreate() {
    ...
    Keyboard kbInfo = new Keyboard(
      "chechen_latin", // Package ID - filename of the .kmp file
      "chechen_latin", // Keyboard ID
      "Chechen Latin Keyboard", // Keyboard Name
      "ce",             // Language ID
      "Chechen",          // Language Name
      ...
      // Font information of the .ttf font to use in Chechen Latin Keyboard (for example "aava1.ttf").
      // chechen_latin doesn't include a font. Can set blank "" or KMManager.KMDefault_KeyboardFont
      // KMEA will use the font for the OSK, but the Android device determines the system font used for keyboard output
      KMManager.KMDefault_KeyboardFont,  // Font for Chechen Latin Keyboard
